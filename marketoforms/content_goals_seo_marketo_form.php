...
<script type="text/javascript"> function mktoGetForm() {return document.getElementById('mktForm_1436'); }</script>
<style>
...
<div class="wpcf7">
<form class="lpeRegForm formNotEmpty" method="post" enctype="application/x-www-form-urlencoded" action="http://fuel.brafton.com/index.php/leadCapture/save" id="mktForm_1436" name="mktForm_1436">
  ...
  <div class="right-col">
    <div class="f-row">
      ...
      <!--<button id='mktFrmSubmit' class="wpcf7-submit button" type="button"  onclick='formSubmit(document.getElementById("mktForm_1436")); return false;' >Submit</button>-->
      <!--<input id='mktFrmSubmit' type='submit' style="width: auto; overflow: visible; padding-left: .25em; padding-right: .25em;" value='Submit' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1436")); return false;' />-->
      <input id='mktFrmSubmit' type='submit' class="wpcf7-submit button" value='Download Now' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1436")); return false;' />
      <input style='display: none;' id='mktFrmReset' type='reset' value='Clear' name='resetButton' onclick='formReset(document.getElementById("mktForm_1436")); return false;' />
    </div>
  </div>
  <span style="display:none;"><input type="text" name="_marketo_comments" value="" /></span>
	...
	<input type="hidden" name="formid" value="1436" />
  <input type="hidden" name="returnURL" value="http://fuel.brafton.com/rs/brafton/images/eBook_01.2015_ContentforGoals_2SEO%20%281%29.pdf" />
  <input type="hidden" name="retURL" value="http://fuel.brafton.com/rs/brafton/images/eBook_01.2015_ContentforGoals_2SEO%20%281%29.pdf" />
...
<script>mktoMunchkin('447-XFF-352', {customName: 'ContentforGoalsDownload', wsInfo: 'j1RR'});</script>
