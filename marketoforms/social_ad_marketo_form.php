...
<script type="text/javascript"> function mktoGetForm() {return document.getElementById('mktForm_1480'); }</script>
<div class="wpcf7">
<form class="lpeRegForm formNotEmpty" method="post" enctype="application/x-www-form-urlencoded" action="http://fuel.brafton.com/index.php/leadCapture/save" id="mktForm_1480" name="mktForm_1480">
  ...
  <div class="right-col">
      ...
      <!--<button id='mktFrmSubmit' class="wpcf7-submit button" type="button"  onclick='formSubmit(document.getElementById("mktForm_1480")); return false;' >Submit</button>-->
      <!--<input id='mktFrmSubmit' type='submit' style="width: auto; overflow: visible; padding-left: .25em; padding-right: .25em;" value='Submit' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1480")); return false;' />-->
      <input id='mktFrmSubmit' type='submit' class="wpcf7-submit button" value='SEND ME THE GUIDE' name='submitButton' onclick='formSubmit(document.getElementById("mktForm_1480")); return false;' />
      <input style='display: none;' id='mktFrmReset' type='reset' value='Clear' name='resetButton' onclick='formReset(document.getElementById("mktForm_1480")); return false;' />
    </div>
  </div>
  <span style="display:none;"><input type="text" name="_marketo_comments" value="" /></span>
	...
	<input type="hidden" name="formid" value="1480" />
  <input type="hidden" name="returnURL" value= "http://fuel.brafton.com/rs/brafton/images/eBook_Content_for_SEO_into_2015.pdf" />
  <input type="hidden" name="retURL" value="http://fuel.brafton.com/SEOeBook_SocialAd.html" />
...
function formSubmit(elt) {
  ...
  ga('send', 'event', 'SEO Social Media Ad', 'Download', '<?php echo curPageURL(); ?>');
...
<script>mktoMunchkin('447-XFF-352', {customName: 'SEOSocialMediaAdDownload', wsInfo: 'j1RR'});</script>
